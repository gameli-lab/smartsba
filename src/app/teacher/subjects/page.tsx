      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Subjects assigned to you across classes</p>
          </div>
        ...
        <Card>
          <CardContent className="py-10 text-center text-gray-500">No subject assignments yet.</CardContent>
        </Card>
      </div>
    )
  }
        ...
        {Object.entries(grouped).map(([classId, subs]) => (
          <Card key={classId}>
            <CardHeader className="pb-2">
              <CardTitle className="text-lg text-gray-900">{subs[0]?.class?.name || 'Class'}</CardTitle>
            ...
            <CardContent className="space-y-2">
              {subs.map((subj) => (
                <div key={subj.id} className="flex items-center justify-between rounded-lg border px-3 py-2">
                  <div>
